...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'fos_user.first_name.not_blank' => 'Veuillez renseigner le prénom s\'il vous plait',
    'fos_user.last_name.not_blank' => 'Veuillez renseigner le nom de famille s\'il vous plait',
    'user.first_name.not_blank' => 'Veuillez renseigner le prénom s\'il vous plait',
    'user.last_name.not_blank' => 'Veuillez renseigner le nom de famille s\'il vous plait',
  ...
  array (
    ...
    'registration.flash.user_created' => 'Votre compte a été créé avec succès',
...
L\'équipe.',
  ...
  'front' => 
  array (
    'password_recovery.action.recover' => 'Retrouver mon mot de passe',
    'password_recovery.action.update' => 'Mettre à jour mon mot de passe',
    'password_recovery.info.email_sent' => 'Un e-mail avec les instructions pour retrouver votre mot de passe a été envoyé à %email%.

Si vous ne l\'avez pas reçu dans quelques minutes, vérifiez votre dossier de spam.
',
    'password_recovery.info.fill_in_email' => 'Entrez votre adresse e-mail, et nous vous enverrons un e-mail avec les instructions pour mettre à jour votre mot de passe.',
    'password_recovery.info.fill_in_new_password' => 'Définissez votre nouveau mot de passe ci-dessous.',
    'password_recovery.label.email' => 'E-mail',
    'password_recovery.label.username' => 'Nom d\'utilisateur',
    'password_recovery.title' => 'Mot de passe oublié',
    'registration.action.go_to_app' => 'Aller sur le site',
    'registration.action.register' => 'S\'inscrire',
    'registration.info.account_activated' => 'Votre compte est maintenant activé.',
    'registration.info.have_account' => 'Déjà inscrit ?',
    'registration.info.subscription_saved' => 'Nous avons bien reçu votre e-mail et nous vous informerons dès notre lancement.',
    'registration.label.first_name' => 'Prénom',
    'registration.label.last_name' => 'Nom de famille',
    'registration.title.confirm' => 'Enregistrement',
    'registration.title.confirmed' => 'Félicitations %username% !',
    'registration.title.register' => 'S\'inscrire',
    'registration.title.registered' => 'Félicitations !',
    'resetting.password_already_requested' => 'Un nouveau mot de passe a déjà été demandé pour cet utilisateur dans les dernières 24 heures.',
    'security.action.forgot_password' => 'Mot de passe oublié ?',
    'security.action.log_in' => 'Connexion',
    'security.action.log_out' => 'Déconnexion',
    'security.action.signup' => 'S\'inscrire',
    'security.label.remember_me' => 'Se souvenir de moi',
    'security.placeholder.email' => 'Email',
    'security.placeholder.password' => 'Mot de passe',
    'security.title.log_in' => 'Connexion',
  ),
));
